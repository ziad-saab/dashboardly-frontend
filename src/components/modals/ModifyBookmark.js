...
class ModifyBookmark extends Component {
  constructor() {
    super();
    this.state = {
      inputValue : ''
  ...
  _handleEdit = (e) => {
    ...
    console.log(this.props, 'the props')
      ...
      console.log("i'm trying to handle the edit")
			...
			api.updateBookmark(this.props.boardId, this.refs.title.value, this.refs.url.value, this.refs.description.value, this.props.id, localStorage.token)
			.then(r => {
        this.props.fetch()
			})
...
export default onClickOutside(ModifyBookmark);
